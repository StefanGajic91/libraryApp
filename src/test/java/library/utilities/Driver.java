   ...
   // private static WebDriver driver;
    ...
    public static WebDriver getDriver(){
        ...
        if(driverPool.get() == null){
            ...
            /*
            depending on the browserType that will be return from Configuration.properties file switch statement will determine the case, and open the marching browser
             */
            switch (browserType){
                case "chrome":
    ...
    //driver.quit()  --> nosuchsession exception
    //driver.close()  -->
